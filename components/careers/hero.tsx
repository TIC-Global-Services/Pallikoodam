    ...
    return (
        <section className="sticky top-0  w-full h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-[90%] mx-auto text-center px-4">
                ...
                <p className='xl:text-3xl lg:text-2xl md:text-xl text-lg text-white max-w-6xl mx-auto mt-5'>
                ...
                <button
                    ...
                    className="inline-block bg-[#000086] z-100 text-white px-6 py-3 rounded-lg mt-[3%] cursor-pointer"
                >
                    View open positions
                </button>
            </div>
