    ...
    return (
        <div className="relative w-full min-h-screen mb-[10%] flex items-center overflow-hidden">
            ...
            <ContainerLayout className="relative z-10 w-full">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-end min-h-[50vh] md:min-h-[80vh]">

                    {/* Left Side (Top Aligned on desktop manually via self-start) */}
                    <div className="text-white flex flex-col justify-start h-full pt-8 md:pt-16">
                    ...
                    <div className="text-white flex flex-col justify-end w-full lg:w-11/12 ml-auto">
                        <p className="text-xl md:text-2xl lg:text-[28px] font-light leading-snug md:leading-[30px] lg:leading-[36px] mb-8 text-white/95">
                        ...
                        <div className="w-full">
                            ...
                            <div className="w-full h-[2px] bg-linear-to-r from-white to-[#000086] mb-5"></div>
                            ...
                            <div className="flex flex-col gap-5">
                                <div className="pb-5 relative ">
                                    ...
                                    <div className="absolute bottom-0 left-0 w-full h-[2px] bg-linear-to-r from-white to-[#000086]"></div>
                                </div>
