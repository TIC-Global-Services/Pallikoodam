...
const StoryAndMission = () => {
  return (
    <section className='w-full bg-white py-10 md:py-20'>
      <ContainerLayout>
        {/* Founder Section */}
        <div className='flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-16 items-start mb-[10vh] md:mb-[15vh]'>
          ...
          {/* Founder Image */}
          <div className='relative w-full aspect-square lg:aspect-auto lg:h-full rounded-2xl overflow-hidden order-1 lg:order-none'>
            <Image
              src={founder}
        ...
        <div className='flex flex-col lg:grid lg:grid-cols-2 gap-8 lg:gap-16 items-center'>
          ...
          <div className='order-1 lg:order-2 relative w-full aspect-square lg:aspect-auto lg:h-full rounded-2xl overflow-hidden'>
            <Image
              src={founder2}
