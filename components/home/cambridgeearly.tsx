...
const CambridgeEarly = () => {
    ...
    return (
        <div className='bg-white py-12 md:py-10 min-h-screen overflow-hidden relative'>
                ...
                <div className="hidden md:flex w-full overflow-hidden relative marquee-container">
                    <div className="flex w-max animate-marquee gap-4 px-4">
                        ...
                        {[...data, ...data].map((item, index) => (
                            <div
                                key={index}
                                className="w-[300px] lg:w-[20vw] min-h-[50dvh] bg-[#EAEAEA] rounded-2xl p-6 md:p-8 flex flex-col flex-shrink-0"
                            >
                                <h3 className="font-ppe italic font-light text-[28px] mb-4 text-black">{item.title}</h3>
                    ...
                    >
                        {data.map((item, index) => (
                            <SwiperSlide key={index}>
                                <div className="w-full min-h-[55dvh] bg-[#EAEAEA] rounded-2xl p-6 flex flex-col h-full">
                                    <h3 className="font-ppe italic font-light text-[24px] mb-4 text-black">{item.title}</h3>
