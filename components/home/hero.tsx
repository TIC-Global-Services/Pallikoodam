        ...
        <div className="flex items-center justify-center h-full w-full">
          ...
          >
            <div className="text-center text-white px-4">
              <h1 className="text-[clamp(14px,4.2vw,3.4rem)] md:leading-[64px] tracking-tight">A <span className="font-ppe font-normal italic">Progressive</span> Teaching  And <br /> Learning Environment  Fousing <br /> On Human <span className="font-ppe italic font-normal">Flourishing</span></h1>
            </div>
          </div>
        </div>
