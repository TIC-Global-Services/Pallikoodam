...
const Empowering = () => {
    ...
    useGSAP(() => {
        // The ScrollTrigger timeline ties entirely to the scroll distance
        const tl = gsap.timeline({
            scrollTrigger: {
                trigger: containerRef.current,
                start: "top top",
                end: "+=300%",     // Slightly reduced allow all staggered cards to sweep through
                scrub: true,       // Strictly tie progress to scrollwheel without smoothing delays
    ...
    return (
        <section
            ref={containerRef}
            className="w-full min-h-screen bg-white overflow-hidden py-16 flex flex-col items-center justify-center relative"
        >
            {/* Title */}
