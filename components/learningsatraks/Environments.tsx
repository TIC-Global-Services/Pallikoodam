            ...
            <div className='relative z-20 bg-[#000086] pt-16 pb-0 px-4 md:px-8 lg:px-[5%] rounded-t-[3rem]'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-6  gap-4 lg:gap-6 pb-6 relative'>
                    ...
                    <div className='lg:col-span-3 lg:row-span-2 flex flex-col justify-between bg-[#F3F4F6] rounded-[24px] lg:rounded-[32px]  overflow-hidden shadow-lg'>
                        <div className='md:hidden flex flex-row w-full items-end gap-4 lg:gap-6 px-2 mb-16 lg:px-[12%] '>
                            <div className='flex flex-col justify-center h-full pt-2'>
                                <div className='shrink-0 w-20 h-20  relative flex items-start justify-start overflow-visible'>
                                    <Image
                                        ...
                                        alt=""
                                        fill
                                        className="object-contain scale-[5]" // 'scale' increases visual size without breaking grid layout space
                                    />
                                </div>
                                <h2 className='text-xl  tracking-tight font-medium text-[#2C313E] leading-[1.2] mb-3 lg:mb-4'>
                                    {features[0].title}
                                </h2>
                        ...
                        <div className='relative w-full aspect-3/2 lg:aspect-[1.5]  lg:rounded-[32px] overflow-hidden mb-0 lg:mb-0'>
                            <Image
                                src={features[0].image}
                                alt="Collaborative Classrooms"
                                fill
                                className="object-cover md:p-4 md:rounded-[32px] object-center"
                            />
                        </div>
                        {/* Content text at bottom */}
                        <div className='md:flex hidden flex-row items-end gap-4 lg:gap-6 px-2 mb-16 lg:px-[12%] '>
                            <div className='shrink-0 w-20 h-20  relative flex items-start justify-start overflow-visible'>
                                <Image
                                    src={features[0].icon}
                                    alt=""
                            ...
                            <div className='flex-1 flex flex-col justify-center px-3 lg:px-1 py-4 lg:py-4'>
                                <div className='shrink-0 w-10 h-10 px-10  md:mb-2 relative flex items-start justify-start overflow-visible'>
                                    <Image
                                        ...
                                        alt=""
                                        fill
                                        className="object-contain scale-[10] lg:scale-[15]" // 'scale' increases visual size without breaking grid layout space
                                    />
                                </div>
