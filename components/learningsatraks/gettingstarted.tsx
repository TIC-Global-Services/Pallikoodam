...
const gettingstarted = () => {
    return (
        <section className='w-full  bg-gray-50 py-[8vh] md:py-[12vh]'>
            <ContainerLayout>
                <div className='relative bg-[#E9E9E9] rounded-[24px] overflow-hidden flex flex-col lg:flex-row shadow-sm px-3'>
                    {/* Background Gradient Layer for the entire container */}
                    <h2 className='md:text-[36px] text-2xl  md:hidden md:px-10 py-5 flex justify-center items-center font-medium lg:hidden leading-[1.1] mb-0 tracking-normal'>
                        Getting <span className='font-ppe font-normal italic mt-1 '>Started </span> & Next Steps
                    </h2>
      ...
      bg-[#000086] opacity-50 rounded-full blur-[130px]' />
                    ...
                    <div className='relative z-10 order-2 lg:order-2 flex-1 p-2 md:p-1   lg:pl-[3%] lg:pr-1 lg:py-16'>
                        ...
                        {/* Mobile Title */}
                        <h2 className='md:text-[36px] hidden md:block font-medium lg:hidden tracking-tight'>
                            Getting <span className='font-ppe font-normal italic m-2'>Started </span> & Next Steps
                        </h2>
                        {/* Desktop Title */}
                        <h2 className='text-[44px] lg:text-[56px] hidden lg:block font-medium mb-2 md:mb-8 leading-[1.1] tracking-tight'>
