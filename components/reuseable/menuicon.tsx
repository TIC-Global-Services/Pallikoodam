  ...
  ({ isOpen, onClick }, ref) => {
    return (
      <button
        ...
        className={`
          relative md:px-3 md:py-2 py-2 px-2 flex items-center justify-center gap-2 cursor-pointer z-50
      ...
      >
        <span className="font-medium text-sm md:text-base uppercase tracking-wide">
          {isOpen ? <X className="text-xl" /> : <Menu className="text-xl" strokeWidth={2.5} />}
        </span>
