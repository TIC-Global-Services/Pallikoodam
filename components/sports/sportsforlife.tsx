...
const SportsForLife = () => {
  ...
  return (
    <section ref={sectionRef} className="w-full relative z-30 -mt-10 md:mt-24 ">
      ...
      <div className="w-full bg-[#000086] rounded-t-[100px] relative overflow-hidden flex flex-col items-center justify-center py-20 md:py-32 shadow-2xl md:shadow-3xl">

        {/* Visuals - Left Ball */}
        <div className="ball-left absolute -left-10 md:-left-1/2 top-1/2 -translate-y-1/2 w-full max-w-[1000vh] aspect-square pointer-events-none">
          <Image src={ball1} alt="Left Ball Elements" fill className="object-contain object-left md:object-center" />
        </div>

        {/* Visuals - Right Ball */}
        <div className="ball-right absolute -right-10 md:-right-1/2 top-1/2 -translate-y-1/2 w-full max-w-[1000vh] aspect-square pointer-events-none">
          <Image src={ball2} alt="Right Ball Elements" fill className="object-contain object-right md:object-center" />
        </div>

        {/* Text Content */}
        <div className="relative z-10 flex flex-col items-center text-center  px-6 md:px-0 text-white">
          ...
          <h3 className="animate-text text-xl md:text-[2.5rem] font-medium mb-6 md:mb-8 leading-snug">
          ...
          <p className="animate-text text-[1rem] md:text-lg lg:text-[1.8rem] leading-relaxed max-w-5xl md:leading-[1.8] text-white/90 font-light px-2 md:px-10">
